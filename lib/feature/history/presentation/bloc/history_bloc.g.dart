...
abstract class _$HistoryStateCWProxy {
  HistoryState message(String? message);

  HistoryState paymentList(List<PaymentEntity>? paymentList);

  HistoryState blocState(BlocState blocState);
...
class _$HistoryStateCWProxyImpl implements _$HistoryStateCWProxy {
  ...
  @override
  HistoryState message(String? message) => this(message: message);
  ...
  @override
  HistoryState blocState(BlocState blocState) => this(blocState: blocState);
  ...
  HistoryState call({
    ...
    return HistoryState(
      message: message == const $CopyWithPlaceholder()
          ...
          : message as String?,
      paymentList: paymentList == const $CopyWithPlaceholder()
          ? _value.paymentList
          // ignore: cast_nullable_to_non_nullable
